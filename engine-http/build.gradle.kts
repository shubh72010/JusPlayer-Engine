...
dependencies {
    ...
    implementation(project(":engine-provider-canvas"))
    implementation(project(":engine-provider-kugou"))
    implementation(project(":engine-provider-simpmusic"))
    implementation(project(":engine-provider-paxsenix"))
    implementation(project(":engine-provider-betterlyrics"))
    implementation(project(":engine-provider-unison"))
    implementation(project(":engine-provider-youlyplus"))
